		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-xs-2">
					<a href="index.html"><img id="fh5co-logo" src="images/rhonin.svg" alt=""></a>
				</div>
				...
				<div class="logo col-md-3 col-xs-4 text-right hidden-xs menu-2">
					<ul>
						<li class="search">
		   			...
		   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<div class="desc">
		   						...
		   						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove.</p>
			   					<p><a href="single.html" class="btn  ">Purchase Now</a></p>
		   					</div>
		   				</div>
		   			</div>
		   		</div>
		...
		<div class="container">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">Copyright &copy; 2016.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/"></a></small> 
					</p>
					<p>
